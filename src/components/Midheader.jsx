      ...
      <section className="w-full  px-4 py-10 bg-[#f9f9f9] text-gray-900">
        <div className="text-center space-y-4">
          <div className="inline-flex relative items-center justify-center gap-2 px-2 py-1 bg-white shadow rounded-lg w-fit mx-auto">
            ...
            <div className="h-5 w-[2px] bg-black absolute left-[-20px] top-[-20px] rotate-320
            before:content-[''] before:absolute before:top-[30%] before:left-[30%] before:w-[15px] before:h-[10px] before:border-r-2 before:border-black before:rotate-[40deg]
            after:content-[''] after:absolute after:top-[30%] after:right-[30%] after:w-[15px] after:h-[10px] after:border-l-2 after:border-black after:-rotate-[40deg]"
            ></div>
          </div>
